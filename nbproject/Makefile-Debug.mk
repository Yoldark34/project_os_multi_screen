...
${OBJECTDIR}/0-Noyau_Start.o: 0-Noyau_Start.ASM 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -f elf -o ${OBJECTDIR}/0-Noyau_Start.o 0-Noyau_Start.ASM
...
${OBJECTDIR}/API.o: API.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/API.o API.c

${OBJECTDIR}/Allocation_Pages.o: Allocation_Pages.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Allocation_Pages.o Allocation_Pages.c

${OBJECTDIR}/Appels_Systeme.o: Appels_Systeme.ASM 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -f elf -o ${OBJECTDIR}/Appels_Systeme.o Appels_Systeme.ASM

${OBJECTDIR}/BitMap_Memoire.o: BitMap_Memoire.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BitMap_Memoire.o BitMap_Memoire.c

${OBJECTDIR}/Buffer_Manager.o: Buffer_Manager.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Buffer_Manager.o Buffer_Manager.c

${OBJECTDIR}/CallBack_Clavier.o: CallBack_Clavier.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CallBack_Clavier.o CallBack_Clavier.c
...
${OBJECTDIR}/CallBack_VIDEO.o: CallBack_VIDEO.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CallBack_VIDEO.o CallBack_VIDEO.c

${OBJECTDIR}/Commutation.o: Commutation.ASM 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -f elf -o ${OBJECTDIR}/Commutation.o Commutation.ASM

${OBJECTDIR}/Couche_User.o: Couche_User.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Couche_User.o Couche_User.c
...
${OBJECTDIR}/EXCEPTIONS.o: EXCEPTIONS.asm 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -f elf -o ${OBJECTDIR}/EXCEPTIONS.o EXCEPTIONS.asm
...
${OBJECTDIR}/HARD_8042_Clavier.o: HARD_8042_Clavier.ASM 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -f elf -o ${OBJECTDIR}/HARD_8042_Clavier.o HARD_8042_Clavier.ASM

${OBJECTDIR}/HARD_8253_Timer.o: HARD_8253_Timer.asm 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -f elf -o ${OBJECTDIR}/HARD_8253_Timer.o HARD_8253_Timer.asm

${OBJECTDIR}/IRQ.o: IRQ.ASM 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -f elf -o ${OBJECTDIR}/IRQ.o IRQ.ASM
...
${OBJECTDIR}/Init_TSS.o: Init_TSS.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Init_TSS.o Init_TSS.c

${OBJECTDIR}/Ordonnanceur.o: Ordonnanceur.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Ordonnanceur.o Ordonnanceur.c
...
${OBJECTDIR}/Pagination.o: Pagination.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Pagination.o Pagination.c
...
${OBJECTDIR}/Tas_pages_Systeme.o: Tas_pages_Systeme.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Tas_pages_Systeme.o Tas_pages_Systeme.c
